...
public class FilterDialog {
    ...
    public Map<String, Object> showFilterDialog(String reportType) {
        ...
        // Komponenty filtrów zależne od typu raportu
        switch (reportType) {
        ...
        // Pokaż dialog i zwróć wynik
        return dialog.showAndWait().orElse(null);
    }

    // Metoda do konfiguracji kontrolek filtrowania zespołów
    ...
    // Metoda do konfiguracji kontrolek filtrowania dat
    ...
    // Metoda do konfiguracji kontrolek filtrowania zadań i członków
    ...
    // Metoda do konfiguracji kontrolek filtrowania członków zespołów
    ...
    // Metoda do konfiguracji kontrolek filtrowania statystyk i zadań
